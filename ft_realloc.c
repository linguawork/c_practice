...
//source: https://sprosi.pro/questions/9819/realizatsiya-realloc-v-c
// https://codereview.stackexchange.com/questions/151019/implementing-realloc-in-c/151021
...
void *my_realloc(void *ptr, size_t originalLength, size_t newLength)
{
   ...
   {
      assert((ptr) && (newLength > originalLength));// эта функция не разрешена
